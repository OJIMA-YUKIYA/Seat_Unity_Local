...
public class SeatSample3:MonoBehaviour
{
    ...
    */
    ...
    void Start ()
	{
        ...
        string[] s1 = { "No.1Up1", "No.1Up2",  };//saveData1のラベル
    ...
    void SetParameterToLength()
    {
        ...
        F_1 = Math.Pow(Math.Pow((a - 1) * 160, 2.0) + Math.Pow((d * 160), 2.0) + Math.Pow(c * 160 + z_c, 2.0), 0.5) - l0;
        F_2 = Math.Pow(Math.Pow((-a + b + 1) * 160, 2.0) + Math.Pow(((-d + e - 1) * 160), 2.0) + Math.Pow((-c + h) * 160 + z_c, 2.0), 0.5) - l0;
        F_3 = Math.Pow(Math.Pow((-a - b + 1) * 160, 2.0) + Math.Pow(((-d - e + 1) * 160), 2.0) + Math.Pow((-c - h) * 160 + z_c, 2.0), 0.5) - l0;
